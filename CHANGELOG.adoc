...
* Add checkbox to customizer to enable or disable the confirmation dialag that used to pop-up when a site visitor clicks on a link referencing a external site.
